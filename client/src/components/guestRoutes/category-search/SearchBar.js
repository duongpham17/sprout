...
const SearchBar = ({searchBarClick, location, product: {posts, length, loading}, auth:{user} }) => {
    ...
    <Pagination route={"category"} posts={posts} getDataRequest={searchBarClick} limit={10} path={location.pathname.slice(8, 1000)} totalProducts={length}
