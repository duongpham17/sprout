...
const Category = ({filterAndCategory, location, product: {posts, length, loading}, auth:{user} }) => {
    ...
    <Pagination route={"category"} posts={posts} getDataRequest={filterAndCategory} limit={10} path={location.pathname.slice(10, 1000)} totalProducts={length}
